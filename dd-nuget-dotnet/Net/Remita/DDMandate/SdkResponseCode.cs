...
namespace RemitaDDMandateSDK.Net.Remita.DDMandate
{
    class SdkResponseCode
    {
        ...
        public const string ERROR_WHILE_CONNECTING = "Error occur while connecting to service...";

        public const string ERROR_PROCESSING_REQUEST_CODE = "25";

        public const string ERROR_PROCESSING_REQUEST = "Error processing request";
        
        public const string INVADE_ENVIRONMENT = "Invalid Environment...";
